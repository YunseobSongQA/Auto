...
const result = {
  ...
  verdict,
  goal: GOAL,
  what: 'QASS 서버(데이터 주는 백엔드)가 얼마나 빠르고 안정적인지',
  why: '사용자가 몰려도 국제 표준 기준 안에서 동작하는지 확인',
  how: `가상 사용자 ${vus}명이 동시에 총 ${totalReq}번 호출 → 응답속도·성공률 측정 → 국제 표준과 비교`,
  runner: `Postman 컬렉션을 Newman으로 실행 (가상 사용자 ${vus}명 × ${iterationsPerVu}회)`,
